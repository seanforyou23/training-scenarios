...
# curl -L https://raw.githubusercontent.com/patternfly/training-scenarios/master/react/react-customize/assets/pageHeaderTools.js > ~/tutorial/src/components/pageHeaderTools.js
touch ./src/app.css
